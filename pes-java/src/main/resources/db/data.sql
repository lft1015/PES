...
(13, 1, '菜单管理', '/system/menu', 'system/menu/index', 'Menu', 'menu:list', 3, 1, 1),
...
(19, 18, '操作日志', '/log/operation', 'log/operation/index', 'Tickets', 'log:list', 1, 1, 1),
(20, 18, '登录日志', '/log/login', 'log/login/index', 'Stamp', 'log:list', 2, 1, 1),
(21, 20, '日志删除', '', '', '', 'log:delete', 3, 2, 1),
